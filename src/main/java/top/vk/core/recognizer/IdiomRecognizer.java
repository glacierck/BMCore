...
public class IdiomRecognizer implements Recognizer
{
    private ACPatternMatcher matcher;
    private int type;
    private boolean isCaseSensitive;
    
    public IdiomRecognizer(final File file, final boolean isCaseSensitive) throws IOException {
        this.type = Item.IDIOM;
