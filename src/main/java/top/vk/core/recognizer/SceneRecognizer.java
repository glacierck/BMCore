...
public class SceneRecognizer implements Recognizer
{
    private ACPatternMatcher matcher;
    private int type;
    private boolean isCaseSensitive;
    
    public SceneRecognizer(final File file, final boolean isCaseSensitive) throws IOException {
        this.type = Item.SCENE;
