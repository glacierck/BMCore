...
public class OrganizationRecognizer implements Recognizer
{
    private ACPatternMatcher matcher;
    private int type;
    private boolean isCaseSensitive;
    
    public OrganizationRecognizer(final File file, final boolean isCaseSensitive) throws IOException {
        this.type = Item.ORGANIZATION;
