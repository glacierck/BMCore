...
public class BiLSTMSetting implements Serializable
{
    ...
    public BiLSTMSetting(final int inputUnits, final int outputUnits, final int numberOfBlock, final int numberOfCell, final int numberOfInput, final BiLSTMObject lstm, final BiOutputLayer outputlayer, final int vocabularyDimension, final int posLabelDimension, final int preprocessLabelDimension, final HashMap<String, double[]> vocabularyLookupTable, final HashMap<String, double[]> posLabelLookupTable, final HashMap<String, double[]> preprocessLabelLookupTable, final String[] labelset, final HashMap<String, Integer> labelIndex) {
