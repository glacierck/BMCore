...
import top.vk.core.crf.CRFMultipleColumnDecoderMultipleEvent;
...
public class CRFSemanticAnalyzerMultipleEvent
{
    ...
    private CRFMultipleColumnDecoderMultipleEvent semanticAnalyzer;
    ...
    public CRFSemanticAnalyzerMultipleEvent(final String preprocessFile, final String posTaggerFile, final String sentenceModelSettingFile, final String confFile) {
        ...
        (this.semanticAnalyzer = new CRFMultipleColumnDecoderMultipleEvent(confFile)).init();
    }
    ...
    public Result semanticAnalyzing(String sentence) {
        ...
        if (this.eventType.equals(this.unkown)) {
            ...
            this.labels = this.semanticAnalyzer.decodeSentence(this.sent, this.eventType);
